...
struct ptest
{
	...
	void setup7()
    {
		...
		particle_renderer_type* pr_type_fire_ball = ps.add_particle_renderer_type("fire_ball_7", "packages/particles/ball2.png", "shader", vec4(255.0f, 255.0f, 0.0f, 0.3f), "billboard_renderer");
